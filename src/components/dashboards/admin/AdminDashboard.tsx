...
type AdminView = 'dashboard' | 'users' | 'templates' | 'contracts' | 'reports' | 'settings' | 'profile';
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform ${
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center justify-center px-3 py-2 text-sm text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors duration-200"
          >
